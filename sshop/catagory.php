...
if(isset($_GET['cat'])){
    $sql = 'SELECT * FROM product p WHERE p.catagory like "%'.$_GET['cat'].'%"';
  ...
  <?php 
	while($res = mysqli_fetch_array($result)) { 
        ...
        echo '<div class="card" style="width:16vw; padding:5px">
                ...
                <img class="card-img-top" src="data:image/png;base64,'.base64_encode($res['pic']).'" alt="Card image"> <button class="watch badge badge-secondary" val="'.$res['id'].'">Add To watch List</button>
                <div class="card-body">
